...
var ErrAccountDoesNotExits = sdkerrors.Register(ModuleName, 6, "account does not exist")
var ErrInvalidDomain = sdkerrors.Register(ModuleName, 7, "invalid domain")
var ErrInvalidOwner = sdkerrors.Register(ModuleName, 8, "invalid owner")
var ErrInvalidName = sdkerrors.Register(ModuleName, 9, "invalid account name")
