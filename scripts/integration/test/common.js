...
export const txUpdateConfigArgs = ( configuration, from ) => {
   return [
      ...
      "--blockchain-target-max", configuration.blockchain_target_max,
      ...
      "--valid-blockchain-address", configuration.valid_blockchain_address,
      "--valid-blockchain-id", configuration.valid_blockchain_id,
